export default function TitleCard() {
  return (
    <div className="mb-24">
      ...
      <h3 className="text-2xl text-slate-500">Austin, TX</h3>
      ...
      {/* Contact button */}
      <button className="flex gap-2 py-2 px-4 bg-blue-500 shadow-lg shadow-blue-500/50 dark:shadow-blue-600/50 dark:hover:shadow-blue-500/50 dark:bg-blue-600 text-slate-50 rounded-lg font-semibold dark:hover:bg-blue-500 transition mt-12">
