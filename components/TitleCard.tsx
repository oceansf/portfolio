...
export default function TitleCard() {
  return (
    <div className="mb-24">
      ...
      <h3 className="font-mono text-xl font-semibold text-slate-500">
        Austin, TX
      </h3>
      <div className="flex space-x-3 mt-1 text-slate-500">
        {/* <!-- Linkedin --> */}
        <a href="http://www.linkedin.com/in/ocean-fuaga-852b76132" target="_blank" rel="noopener noreferrer">
          <svg
        ...
        {/* <!-- Github --> */}
        <a href="http://www.github.com/oceansf" target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 hover:cursor-pointer hover:text-blue-500 dark:hover:text-slate-50 transition"
            fill="currentColor"
