    ...
    <div className="hidden lg:sticky top-0 h-screen w-3/4 items-end lg:flex lg:max-h-screen lg:flex-col lg:py-64">
      <div>
        ...
        <div className="flex mt-3 gap-2 justify-start">
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/ocean-fuaga-852b76132" target="_blank">
            <svg
              className="w-6 h-6 text-slate-400 hover:text-slate-200 transition-colors"
              aria-hidden="true"
          ...
          {/* GitHub */}
          <a href="https://github.com/oceansf" target="_blank">
            <svg
              className="w-6 h-6 text-slate-400 hover:text-slate-200 transition-colors"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
